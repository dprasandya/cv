Ext.define('App.view.popup.Customer',
    {
        extend : 'Ext.form.field.Trigger',
        alias : 'widget.xtcustomer',
                ...
                tbar: [
                    ...
                    },
                    {
                        ...
                        listeners:{specialkey:function(field, e){if(e.getKey()== e.ENTER){
                            me.store.proxy.extraParams = {cust_type:me.extraParams, field_name:me.field_name, field_search:field.value};
                            me.store.loadPage(1);}}
                        }
                    },
                    {
        ...
        onTrigger1Click : function(){
            ...
            me.store.proxy.extraParams = { cust_type:me.extraParams};
            me.store.load();
            me.doComponentLayout();
        },
        gridclick: function(grid, selected){
            var form = this.up('container'),
                cust_name = Ext.ComponentQuery.query('[name=cust_name]', form)[0];
            if(cust_name){cust_name.setValue(selected.data.cust_name);}
            this.setValue(selected.data.cust_id);
        },
