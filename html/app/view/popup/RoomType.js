Ext.define('App.view.popup.RoomType',
    {
        extend : 'Ext.form.field.Trigger',
        alias : 'widget.xtroom_type',
        ...
        initComponent : function()
        {
            ...
            me.grid = Ext.create('Ext.grid.Panel', {
                ...
                columns: [
                    {text: _('id'),width: 80,sortable: true,dataIndex: 'rt_id'},
                    {text: _('name'),flex: 1,sortable: true,dataIndex: 'rt_name'}
                ],
                tbar: [
                    {
                        xtype:'combo',
        ...
        gridclick: function(grid, selected){
            this.setValue(selected.data.rt_id);
            var form = this.up('container'),
                rt_name = Ext.ComponentQuery.query('[name=rt_name]', form)[0];
