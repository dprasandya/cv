Ext.define('App.view.popup.Cashbook',
    {
        extend : 'Ext.form.field.Trigger',
        alias : 'widget.xtcashbook',
                ...
                tbar: [
                    {
                        ...
                        width:100,
                        mode:'local',
                        store: [['doc_id',_('document')],['vend_cust_id',_('id')],['vend_cust_name',_('name')],['nominal',_('amount')],['remarks',_('remarks')]],
                    ...
                    },
                    {
                        ...
                        listeners:{specialkey:function(field, e){if(e.getKey()== e.ENTER){
                            me.store.proxy.extraParams = {field_name:me.field_name, field_search:field.value, start:0};
                            me.store.loadPage(1);}}
                        }
                    },
                    {
