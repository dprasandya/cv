Ext.define('App.view.popup.Asset',
    {
        extend : 'Ext.form.field.Trigger',
        alias : 'widget.xtasset',
                ...
                tbar: [
                    {
                        ...
                        width:100,
                        mode:'local',
                        store: [['doc_id',_('document')],['coa_id',_('account')],['coa_name',_('name')],['total',_('total')],['remarks',_('remarks')]],
        ...
        gridclick: function(grid, selected){
            ...
            var selling_price = Ext.ComponentQuery.query('[name=selling_price]', container)[0],
                coa_id = Ext.ComponentQuery.query('[name=coa_id]', container)[0],
                coa_name = Ext.ComponentQuery.query('[name=coa_name]', container)[0];
            if(selling_price){selling_price.setValue(selected.data.total);}
            if(coa_id){coa_id.setValue(selected.data.coa_id);}
            if(coa_name){coa_name.setValue(selected.data.coa_name);}
