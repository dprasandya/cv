Ext.define('App.view.popup.UnitBuilding',
    {
        extend : 'Ext.form.field.Trigger',
        alias : 'widget.xtunitbuilding',
                ...
                tbar: [
                    ...
                    },
                    {
                        ...
                        listeners:{specialkey:function(field, e){if(e.getKey()== e.ENTER){
                            me.store.proxy.extraParams = {unit_building_status:me.extraParams, field_name:me.field_name, field_search:field.value};
                            me.store.loadPage(1);}}
        ...
        onTrigger1Click : function(){
            ...
            me.store.proxy.extraParams = { unit_building_status:me.extraParams};
            me.store.load();
            me.doComponentLayout();
        },
        gridclick: function(grid, selected){
            this.setValue(selected.data.unit_building_id);
            var me = this, form = this.up('container'), panel = form.up('panel'),  plugin = panel.ownerCt.editingPlugin;
            if(plugin){
                var project_id = plugin.editor.form.findField('project_id'), cluster_id = plugin.editor.form.findField('cluster_id'),
                ...
                var project_id = Ext.ComponentQuery.query('[name=project_id]', panel)[0],
            ...
            if(price){price.setValue(selected.data.total);}
        },
