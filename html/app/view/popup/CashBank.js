Ext.define('App.view.popup.CashBank',
    {
        extend : 'Ext.form.field.Trigger',
        alias : 'widget.xtcashbank',
        ...
        initComponent : function()
        {
            ...
            me.grid = Ext.create('Ext.grid.Panel', {
                ...
                columns: [
                    ...
                    {text: _('type'),width: 80,sortable: true,dataIndex: 'cash_type'},
                ...
                tbar: [
                    {
                        ...
                        width:100,
                        mode:'local',
                        store: [['cash_id',_('id')],['cash_name',_('name')],['remarks',_('remarks')],['cash_type',_('type')]],
