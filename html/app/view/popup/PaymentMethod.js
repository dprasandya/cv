Ext.define('App.view.popup.PaymentMethod',
    {
        extend : 'Ext.form.field.Trigger',
        alias : 'widget.xtpaymentmethod',
        ...
        initComponent : function()
        {
            ...
            me.grid = Ext.create('Ext.grid.Panel', {
                ...
                columns: [
                    ...
                    {text: _('type')+' KPA',width: 80,sortable: true,dataIndex: 'payment_type'},
        ...
        gridclick: function(grid, selected){
            this.setValue(selected.data.payment_id);
            var form = this.up('container'), container = form.up('container'),
                cash_id = Ext.ComponentQuery.query('[name=cash_id]', container)[0];
            form.items.items[1].setValue(selected.data.payment_name);
            if(selected.data.payment_type=='Y'){
               if(cash_id){cash_id.setDisabled(false);}
            }else{
                if(cash_id){cash_id.setValue(''); cash_id.setDisabled(true);}
            }
