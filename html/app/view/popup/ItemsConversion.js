Ext.define('App.view.popup.ItemsConversion',
    {
        extend : 'Ext.form.field.Trigger',
        alias : 'widget.xtitemsconversion',
        ...
        initComponent : function()
        {
            ...
            me.grid = Ext.create('Ext.grid.Panel', {
                ...
                columns: [
                    ...
                    {text: _('unit'),width: 80,sortable: true,dataIndex: 'unit_id_conversion'},
                ...
                tbar: [
                    {
                        ...
                        width:100,
                        mode:'local',
                        store: [['item_id',_('id')],['item_name',_('name')],['costcode_id',_('costcode')+' Id'],['costcode_name',_('costcode')+' '+_('name')],['unit_id_conversion',_('unit')],['item_type',_('type')]],
        ...
        gridclick: function(grid, selected){
            ...
            if(unit_id){unit_id.setValue(selected.data.unit_id_conversion);}
