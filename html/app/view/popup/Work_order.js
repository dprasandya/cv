Ext.define('App.view.popup.Work_order',
    {
        extend : 'Ext.form.field.Trigger',
        alias : 'widget.xtwork_order',
        ...
        initComponent : function()
        {
            ...
            me.grid = Ext.create('Ext.grid.Panel', {
                ...
                columns: [
                    ...
                    {text: _('contract')+' '+_('value'),width: 100,sortable: true,dataIndex: 'contract_value', align:'right', renderer: Ext.util.Format.numberRenderer('0,000.00')},
                ...
                tbar: [
                    {
                        ...
                        width:100,
                        mode:'local',
                        store: [['project_name',_('project')],['doc_id',_('document')], ['contract_no',_('contract_no')],['vend_name',_('supplier')],['contract_value',_('contract')+' '+_('value')],['remarks',_('remarks')]],
