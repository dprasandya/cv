Ext.define('App.view.popup.Salesman',
    {
        extend : 'Ext.form.field.Trigger',
        alias : 'widget.xtsalesman',
        ...
        initComponent : function()
        {
            ...
            me.grid = Ext.create('Ext.grid.Panel', {
                ...
                columns: [
                    {text: _('id'),width: 80,sortable: true,dataIndex: 'sales_id'},
                ...
                tbar: [
                    {
                        ...
                        width:100,
                        mode:'local',
                        store: [['sales_id',_('id')],['sales_name',_('name')],['city',_('city')],['remarks',_('remarks')]],
        ...
        gridclick: function(grid, selected){
            this.setValue(selected.data.sales_id);
            var form = this.up('container');
            form.items.items[1].setValue(selected.data.sales_name);
        },
