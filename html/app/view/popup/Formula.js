Ext.define('App.view.popup.Formula',
    {
        extend : 'Ext.form.field.Trigger',
        alias : 'widget.xtformula',
        ...
        initComponent : function()
        {
            ...
            me.grid = Ext.create('Ext.grid.Panel', {
                ...
                columns: [
                    {text: _('id'),width: 80,sortable: true,dataIndex: 'formula_id'},
                ...
                tbar: [
                    {
                        ...
                        width:100,
                        mode:'local',
                        store: [['formula_id',_('id')],['formula_name',_('name')]],
        ...
        gridclick: function(grid, selected){
            this.setValue(selected.data.formula_id);
            var form = this.up('container');
            form.items.items[1].setValue(selected.data.formula_name);
        },
