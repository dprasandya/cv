Ext.define('App.view.popup.Cashflow',
    {
        extend : 'Ext.form.field.Trigger',
        alias : 'widget.xtcashflow',
        ...
        initComponent : function()
        {
            ...
            me.grid = Ext.create('Ext.grid.Panel', {
                ...
                columns: [
                    ...
                    {text: _('type'),width: 80,sortable: true,dataIndex: 'cflow_type'},
                ...
                tbar: [
                    {
                        ...
                        width:100,
                        mode:'local',
                        store: [['cflow_id',_('id')],['cflow_name',_('name')],['cflow_type',_('type')],['remarks',_('remarks')]],
        ...
        gridclick: function(grid, selected){
            this.setValue(selected.data.cflow_id);
            var form = this.up('container');
            if(form.items.items[1]){form.items.items[1].setValue(selected.data.cflow_name);}
        },
