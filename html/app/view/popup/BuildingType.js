Ext.define('App.view.popup.BuildingType',
    {
        extend : 'Ext.form.field.Trigger',
        alias : 'widget.xtbuildingtype',
                ...
                tbar: [
                    {
                        ...
                        width:100,
                        mode:'local',
                        store: [['building_id',_('id')],['building_name',_('name')],['remarks',_('remarks')]],
                    ...
                    },
                    {
                        ...
                        listeners:{specialkey:function(field, e){if(e.getKey()== e.ENTER){
                            me.store.proxy.extraParams = {project_id:me.extraParams[0].project_id, cluster_id:me.extraParams[0].cluster_id, field_name:me.field_name, field_search:field.value};
                            me.store.loadPage(1);}}
        ...
        onTrigger1Click : function(){
            ...
            me.store.proxy.extraParams={project_id:me.extraParams[0].project_id, cluster_id:me.extraParams[0].cluster_id};
            me.store.load();
            me.doComponentLayout();
        },
        gridclick: function(grid, selected){
            this.setValue(selected.data.building_id);
            var form = this.up('container'),
                building_name = Ext.ComponentQuery.query('[name=building_name]', form)[0];
