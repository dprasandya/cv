...
Ext.define('App.view.transactions.reclass.Reclass_plasma', {
    extend: 'App.ux.RenderPanel',
    pageTitle: _('reclass_plasma'),
    initComponent: function(){
        var me = this;
        // *************************************************************************************
        // Module Data Store
        // *************************************************************************************
        me.store = Ext.create('App.store.transactions.reclass.Reclass_plasma',{remoteSort: false});
        me.store_reclass_plasma = Ext.create('App.store.transactions.reclass.JurnalReclass_plasma',{remoteSort: false});
        me.jurnal = Ext.create('App.view.transactions.jurnal.Jurnal');

        me.grid = Ext.create('Ext.grid.Panel', {
            store: me.store,
            title: _('reclass_plasma'),
            ...
            columns: [
                ...
                {text: _('quantiti'),width: 80,sortable: true,dataIndex: 'qty', align:'right',renderer: Ext.util.Format.numberRenderer('0,000.00')},
            ...
            tbar: [
                ...
                },
                {
                    ...
                    width:100,
                    mode:'local',
                    store: [['for_doc_id',_('document')],['vend_name',_('supplier')],['afdeling_name',_('afdeling')],['warehouse_name',_('warehouse')],['remarks',_('remarks')],['total',_('subtotal')]],
        ...
        me.grid_reclass_plasma = Ext.create('Ext.grid.Panel', {
            store: me.store_reclass_plasma,
            title: _('jurnal'),
            viewConfig :
            {
                stripeRows: false,
            ...
            tbar: [
                {
                    ...
                    width:100,
                    mode:'local',
                    store: [['doc_id',_('document')],['for_doc_id',_('document')],['vend_name',_('supplier')],['afdeling_name',_('afdeling')],['remarks',_('remarks')],['warehouse_name',_('warehouse')]],
                    listeners:{change:function(){me.field_name=this.getValue();}}
                },
                {
                    xtype:'textfield',
        ...
        me.FormulirPanel = Ext.create('Ext.tab.Panel', {
            activeTab:0,
            items:[ me.grid, me.grid_reclass_plasma ],
            listeners: {
                render: function() {
    ...
    onNewData: function(btn){
        ...
        for (var i = 0, len = length; i < len; i++) {
            ...
            Reclass_plasma.add(data, function(provider, response){
