...
Ext.define('App.view.transactions.reclass.Reclass_transport', {
    extend: 'App.ux.RenderPanel',
    id: 'panelReclass_transport',
    pageTitle: _('reclass_transport'),
    initComponent: function(){
        var me = this;
        // *************************************************************************************
        // Module Data Store
        // *************************************************************************************
        me.store = Ext.create('App.store.transactions.reclass.Reclass_transport',{remoteSort: true});
        me.store_reclass_transport = Ext.create('App.store.transactions.reclass.JurnalReclass_transport',{remoteSort: true});
        me.jurnal = Ext.create('App.view.transactions.jurnal.Jurnal');

        me.grid = Ext.create('Ext.grid.Panel', {
            store: me.store,
            title: _('reclass_transport'),
            ...
            tbar: [
                ...
                },
                {
                    ...
                    width:100,
                    mode:'local',
                    store: [['for_doc_id',_('document')],['coa_id',_('id')],['coa_name',_('name')],['remarks',_('remarks')],['total',_('subtotal')],['doc_type',_('type')]],
        ...
        me.grid_reclass_transport = Ext.create('Ext.grid.Panel', {
            store: me.store_reclass_transport,
            title: _('jurnal'),
            viewConfig :
            {
                stripeRows: false,
            ...
            tbar: [
                ...
                },
                {
                    ...
                    emptyText: 'enter search key',
                    width:150,
                    listeners:{specialkey:function(field, e){if(e.getKey()== e.ENTER){me.store_reclass_transport.load({params:{field_name:me.field_name, field_search:field.value, start:0, limit:15}})}}}
                },'->',
                {
                    xtype: 'label'
                }
        ...
        me.FormulirPanel = Ext.create('Ext.tab.Panel', {
            activeTab:0,
            items:[ me.grid, me.grid_reclass_transport ],
            listeners: {
                render: function() {
