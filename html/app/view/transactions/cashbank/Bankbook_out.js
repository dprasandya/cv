...
Ext.define('App.view.transactions.cashbank.Bankbook_out', {
    extend: 'App.ux.RenderPanel',
    id: 'panelBankbook_out',
    pageTitle: _('bankbookout'),
    initComponent: function(){
        var me = this;
        // *************************************************************************************
        // Module Data Store
        // *************************************************************************************
        me.store = Ext.create('App.store.transactions.cashbank.Bankbook',{remoteSort: true, pageSize : 20,  autoLoad: false});
        me.store_detail = Ext.create('App.store.transactions.cashbank.Bankbook_detail');
        me.jurnal = Ext.create('App.view.transactions.jurnal.Jurnal');
        me.myupload= new Ext.FormPanel({
            fileUpload: true,
            title :'upload '+_('bankbookout'),
            width: 500,
            autoHeight: true,
                ...
                handler: function(){
                    if(me.myupload.getForm().isValid()){
                        ...
                        me.myupload.getForm().submit({
                            url: 'dataProvider/Bankbook_out_Fileupload.php',
        ...
        me.grid = Ext.create('Ext.grid.Panel', {
            ...
            plugins: [
                me.formEditing = Ext.create('App.ux.grid.RowFormEditing', {
                    clicksToEdit: 1,
                    enablePrint : true,
                    enablePrintFn : voucher_report.bank_form_report,
                    items:[
                        {
                            xtype: 'tabpanel',
                            items: [
            ...
            tbar: [
                ...
                },
                {
                    ...
                    width:100,
                    mode:'local',
                    store: [['doc_id',_('document')],['vend_name',_('supplier')],['cash_name','Bank'],['reference_id',_('giro_check')],['nominal',_('amount')],['remarks',_('remarks')],['userinput',_('input_user')]],
     ...
     onNewData: function(btn){
         ...
         me.formEditing.context.record.data.doc_type = 'O';
    ...
    onActive: function(callback){
        this.store.proxy.extraParams = {doc_type: 'O'};
        this.store.load();
        callback(true);
    }
});
