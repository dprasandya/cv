...
Ext.define('App.view.transactions.cashbank.Bankbook_in', {
    extend: 'App.ux.RenderPanel',
    id: 'panelCasbook_in',
    pageTitle: _('bankbookin'),
                ...
                handler: function(){
                    if(me.myupload.getForm().isValid()){
                        ...
                        me.myupload.getForm().submit({
                            url: 'dataProvider/Bankbook_in_Fileupload.php',
        ...
        me.grid = Ext.create('Ext.grid.Panel', {
            ...
            tbar: [
                ...
                },
                {
                    ...
                    width:100,
                    mode:'local',
                    store: [['doc_id',_('document')],['cust_id',_('id')],['cust_name',_('customer')],['cash_name','Bank'],['nominal',_('amount')],['remarks',_('remarks')],['userinput',_('input_user')]],
