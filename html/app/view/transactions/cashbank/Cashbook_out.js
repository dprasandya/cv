...
Ext.define('App.view.transactions.cashbank.Cashbook_out', {
    extend: 'App.ux.RenderPanel',
    id: 'panelCashbook_out',
    pageTitle: _('cashbookout'),
                ...
                handler: function(){
                    if(me.myupload.getForm().isValid()){
                        ...
                        me.myupload.getForm().submit({
                            url: 'dataProvider/Cashbook_out_Fileupload.php',
        ...
        me.grid = Ext.create('Ext.grid.Panel', {
            ...
            tbar: [
                ...
                },
                {
                    ...
                    width:100,
                    mode:'local',
                    store: [['doc_id',_('document')],['vend_id',_('id')],['vend_name',_('supplier')],['cash_name',_('cash')],['nominal',_('payment_amount')],['remarks',_('remarks')],['userinput',_('input_user')]],
