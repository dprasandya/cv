...
Ext.define('App.view.transactions.deliveryorder.Delivery_order_letter', {
    extend: 'App.ux.RenderPanel',
    id: 'panelDelivery_order_letter',
    pageTitle: _('delivery_order_letter'),
    initComponent: function(){
        ...
        // Module Data Store
        // *************************************************************************************
        me.store = Ext.create('App.store.transactions.deliveryorder.Delivery_order_letter',{remoteSort: true, pageSize : 20, autoLoad: false});
        me.store_detail = Ext.create('App.store.transactions.deliveryorder.Delivery_order_letter_detail',{remoteSort: true, pageSize : 20});
                    ...
                    listeners: {
                        beforeedit: function(editor,e,opt){
                            if(me.status==1 || me.status==2){
                                ...
                                var cust_id  = form.findField('cust_id'), qty = form.findField('qty');
                                if(me.doc_type=='S'){
        ...
        me.grid = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                ...
                {text: _('type'),width: 100,sortable: true,
                    renderer: function (value, metaData, record, rowIndex, colIndex, store) {
                        var returnString = record.data.doc_type =="S" ? "Sales Order" : "Items";
                        return returnString;
                    }},
