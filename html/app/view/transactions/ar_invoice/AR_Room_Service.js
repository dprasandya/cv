Ext.define('App.view.transactions.ar_invoice.AR_Room_Service', {
    extend: 'App.ux.RenderPanel',
    pageTitle: _('room_service'),
                                                                        ...
                                                                        },
                                                                        {
                                                                            ...
                                                                            listeners:{
                                                                                change:function(field){
                                                                                    ...
                                                                                    //costcode_id.setValue(null);   costcode_id.extraParams={doc_type:'B', project_id:field.value};
                                                                                }
                                                                            }
                                                                        }
                                                                    ]
            ...
            tbar: [
                ...
                },
                {
                    ...
                    listeners:{specialkey:function(field, e){if(e.getKey()== e.ENTER){
                            me.store.proxy.extraParams = {doc_type:'S', field_name:me.field_name, field_search:field.value};
                            me.store.loadPage(1);}}
                    }
                },'->',
                {
    ...
    onNewData: function(btn){
        ...
        me.formEditing.context.record.data.doc_type = 'S';
    ...
    onActive: function(callback){
        this.store.proxy.extraParams = {doc_type:'S'};
        this.store.load();
        callback(true);
    }
});
