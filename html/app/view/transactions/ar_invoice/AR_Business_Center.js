Ext.define('App.view.transactions.ar_invoice.AR_Business_Center', {
    extend: 'App.ux.RenderPanel',
    pageTitle: _('business_center'),
            ...
            tbar: [
                ...
                },
                {
                    ...
                    listeners:{specialkey:function(field, e){if(e.getKey()== e.ENTER){
                        me.store.proxy.extraParams = {doc_type:'B', field_name:me.field_name, field_search:field.value};
                        me.store.loadPage(1);}}
                    }
                },'->',
                {
    ...
    onActive: function(callback){
        this.store.proxy.extraParams = {doc_type:'B'};
        this.store.load();
        callback(true);
    }
});
