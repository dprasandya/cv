Ext.define('App.view.transactions.ar_invoice.AR_House_Keeping', {
    extend: 'App.ux.RenderPanel',
    pageTitle: _('house_keeping'),
            ...
            tbar: [
                ...
                },
                {
                    ...
                    listeners:{specialkey:function(field, e){if(e.getKey()== e.ENTER){
                        me.store.proxy.extraParams = {doc_type:'H', field_name:me.field_name, field_search:field.value};
                        me.store.loadPage(1);}}
                    }
                },'->',
                {
    ...
    onNewData: function(btn){
        ...
        me.formEditing.context.record.data.doc_type = 'H';
    ...
    onActive: function(callback){
        this.store.proxy.extraParams = {doc_type:'H'};
        this.store.load();
        callback(true);
    }
});
