...
Ext.define('App.view.transactions.ar_invoice.AR_Alocation', {
    extend: 'App.ux.RenderPanel',
    id: 'panelAR_Alocation',
    pageTitle: _('alocation'),
    initComponent: function(){
        ...
        // Module Data Store
        // *************************************************************************************
        me.store = Ext.create('App.store.transactions.ar_invoice.AR_Alocation',{remoteSort: true, pageSize : 20, autoLoad: false});
            ...
            tbar: [
                ...
                },
                {
                    ...
                    listeners:{specialkey:function(field, e){if(e.getKey()== e.ENTER){
                        me.store.proxy.extraParams = {doc_type:'A', field_name:me.field_name, field_search:field.valu};
                        me.store.loadPage(1);}}
                    }
                },'->',
                {
    ...
    onActive: function(callback){
        var me = this;
        me.store.proxy.extraParams = {doc_type: 'A'};
        me.store.load();
        callback(true);
    }
});
