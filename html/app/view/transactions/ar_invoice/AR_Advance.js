...
Ext.define('App.view.transactions.ar_invoice.AR_Advance', {
    ...
    initComponent: function(){
        ...
        // Module Data Store
        // *************************************************************************************
        me.store = Ext.create('App.store.transactions.ar_invoice.AR_Advance',{remoteSort: true, pageSize : 20, autoLoad: false});
        ...
        me.grid = Ext.create('Ext.grid.Panel', {
            ...
            tbar: [
                ...
                },
                {
                    ...
                    width:100,
                    mode:'local',
                    store: [['doc_id',_('document')],['cust_name',_('customer')],['cash_name',_('cashbank')],['nominal',_('payment_amount')],['tax_no','Tax No'],['remarks',_('remarks')],['userinput',_('input_user')]],
