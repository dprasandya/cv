...
Ext.define('App.view.transactions.ar_invoice.AR_Deduction', {
    ...
    initComponent: function(){
        ...
        // Module Data Store
        // *************************************************************************************
        me.store = Ext.create('App.store.transactions.ar_invoice.AR_Deduction',{remoteSort: true, pageSize : 20, autoLoad: false});
        ...
        me.grid_detail = Ext.create('Ext.grid.Panel', {
            ...
            listeners :{
                itemclick: function(dv, record, item, index, e) {
                    console.log(record.data.coa_id);
                    var plugin = me.grid_detail.editingPlugin;
                    if(record.data.costcode_id!=''){plugin.editor.form.findField('costcode_id').setReadOnly(false)}else{plugin.editor.form.findField('costcode_id').setReadOnly(true)}
            ...
            tbar: [
                ...
                },
                {
                    ...
                    listeners:{specialkey:function(field, e){if(e.getKey()== e.ENTER){
                        me.store.proxy.extraParams = {doc_type:'D', field_name:me.field_name, field_search:field.valu};
                        me.store.loadPage(1);}}
                    }
                },'->',
                {
