Ext.define('App.view.transactions.ar_invoice.AR_Coffee_shop', {
    extend: 'App.ux.RenderPanel',
    pageTitle: _('ar_coffee_shop'),
            ...
            tbar: [
                ...
                },
                {
                    ...
                    listeners:{specialkey:function(field, e){if(e.getKey()== e.ENTER){
                            me.store.proxy.extraParams = {doc_type:'C', field_name:me.field_name, field_search:field.value};
                            me.store.loadPage(1);}}
                    }
                },'->',
                {
    ...
    onNewData: function(btn){
        ...
        me.formEditing.context.record.data.doc_type = 'C';
    ...
    onActive: function(callback){
        this.store.proxy.extraParams = {doc_type:'C'};
        this.store.load();
        callback(true);
    }
});
