...
Ext.define('App.view.transactions.general_ledger.Asset_recognition', {
    extend: 'App.ux.RenderPanel',
    pageTitle: _('asset_recognition'),
    initComponent: function(){
        ...
        // Module Data Store
        // *************************************************************************************
        me.store = Ext.create('App.store.transactions.general_ledger.Asset_recognition',{remoteSort: true,  pageSize : 20, autoLoad: false});
        me.store_jurnal = Ext.create('App.store.transactions.general_ledger.JurnalAsset_recognition',{remoteSort: true,  pageSize : 20, autoLoad: false});
     ...
     onNewData: function(btn){
         ...
         for (var i = 0, len = length; i < len; i++) {
             ...
             Asset_recognition.add(data, function(provider, response){
