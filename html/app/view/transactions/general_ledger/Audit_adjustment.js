...
Ext.define('App.view.transactions.general_ledger.Audit_adjustment', {
    extend: 'App.ux.RenderPanel',
    id: 'panelAudit_adjustment',
    pageTitle: _('audit_adjustment'),
    initComponent: function(){
        ...
        // Module Data Store
        // *************************************************************************************
        me.store = Ext.create('App.store.transactions.general_ledger.Audit_adjustment',{remoteSort: true,  pageSize : 20, autoLoad: false});
        me.store_detail = Ext.create('App.store.transactions.general_ledger.Audit_adjustment_detail');
        ...
        me.grid = Ext.create('Ext.grid.Panel', {
            ...
            tbar: [
                ...
                },
                {
                    ...
                    width:100,
                    mode:'local',
                    store: [['project_name',_('project')],['doc_id',_('document')],['nominal',_('amount')],['remarks',_('remarks')],['userinput',_('input_user')]],
