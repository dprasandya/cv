...
Ext.define('App.view.transactions.stock.Stock_out_pks', {
    extend: 'App.ux.RenderPanel',
    pageTitle: _('stock_out_pks'),
        ...
        me.grid = Ext.create('Ext.grid.Panel', {
            ...
            tbar: [
                ...
                },
                {
                    ...
                    width:100,
                    mode:'local',
                    store: [['doc_id',_('document')],['warehouse_name',_('warehouse')],['doc_id_rm',_('production')],['remarks',_('remarks')],['userinput',_('input_user')]],
                    listeners:{change:function(){me.field_name=this.getValue();}}
                },
                {
                    xtype:'textfield',
                    ...
                    width:150,
                    listeners:{specialkey:function(field, e){if(e.getKey()== e.ENTER){
                        me.store.proxy.extraParams = {doc_type:'PKS', field_name:me.field_name, field_search:field.value};
                        me.store.loadPage(1);}}
                    }
                },'->',
                {
    ...
    onNewData: function(btn){
        ...
        me.edditing.context.record.data.doc_type = 'PKS';
        me.edditing.context.record.data.ol_id = 'PKS01';
    ...
    onActive: function(callback){
        var me = this;
        me.store.proxy.extraParams ={doc_type:'PKS'};
        me.store.load();
        callback(true);
    }
});
