...
Ext.define('App.view.transactions.salesorder.Sales_order_revision', {
    extend: 'App.ux.RenderPanel',
    pageTitle: _('salesorder_revision'),
    initComponent: function(){
        ...
        me.model =Ext.define('model',{
            ...
            fields :[
                ...
                {name:'remarks_revision', type:'string'},
            ...
            proxy:{
                type:'direct',
                api:{
                    read: Sales_order_revision.select,
                    update: Sales_order_revision.update
                },
                reader :{
                    root: 'rows',
        ...
        me.model_detail =Ext.define('model',{
            ...
            proxy:{
                type:'direct',
                api:{
                    read: Sales_order_revision.selectdetail,
                    update: Sales_order_revision.updatedetail
                },
                reader :{
                    root: 'rows',
                    totalProperty: 'totals'
        ...
        me.model_detail_ext =Ext.define('model',{
            ...
            proxy:{
                type:'direct',
                api:{
                    read: Sales_order_revision.selectdetail_ext,
                    create: Sales_order_revision.adddetail_ext,
                    update: Sales_order_revision.updatedetail_ext,
                    destroy: Sales_order_revision.deletedetail_ext
                },
                reader :{
                    root: 'rows',
                    totalProperty: 'totals'
        ...
        me.grid_detail_ext = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                ...
                {text: _('name'),flex: 1,sortable: true,dataIndex: 'sales_name', summaryRenderer: function(){return '<b>Total</b>';}},
                {text: _('quantity'),width: 80,sortable: true,dataIndex: 'qty', align:'right', summaryType:'sum', renderer: Ext.util.Format.numberRenderer('0,000.00')}
            ],
            features: [{
                ftype: 'summary'
            }],
