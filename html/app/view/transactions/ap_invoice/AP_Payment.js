...
Ext.define('App.view.transactions.ap_invoice.AP_Payment', {
    ...
    initComponent: function(){
        ...
        // Module Data Store
        // *************************************************************************************
        me.store = Ext.create('App.store.transactions.ap_invoice.AP_Payment',{remoteSort: true, pageSize : 20, autoLoad: false});
        ...
        me.grid = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                ...
                {text: _('giro_check'),width: 100,sortable: true,dataIndex: 'reference_id'},
            ...
            tbar: [
                ...
                },
                {
                    ...
                    width:100,
                    mode:'local',
                    store: [['doc_id',_('document')],['for_doc_id',_('invoice')],['reference_id',_('giro_check')],['cash_name',_('cashbank')],['nominal',_('payment_amount')],['reference_id',_('giro_check')],['remarks',_('remarks')],['userinput',_('input_user')]],
