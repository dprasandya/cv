...
Ext.define('App.view.transactions.ap_invoice.AP_Invoice', {
                ...
                handler: function(){
                    if(me.myupload.getForm().isValid()){
                        ...
                        me.myupload.getForm().submit({
                            url: 'dataProvider/AP_Invoice_Fileupload.php',
                                                                    ...
                                                                    items: [
                                                                        {
                                                                            ...
                                                                            width:130,
                                                                            mode:'local',
                                                                            store: [['P','Purchase'],['O','Others'],['A','Asset']],
                                                                            emptyText   : _('select'),
                                                                            allowBlank:false,
                                                                            listeners:{
                                                                                change:function(field){
                                                                                    ...
                                                                                    if(me.type=='P'){
                                                                                        for_doc_id.setDisabled(false); vend_id.extraParams =['S'];
                                                                                    }
                                                                                    else{
                                                                                        for_doc_id.setDisabled(true); vend_id.extraParams =['S']; 
                                                                                    }
