...
Ext.define('App.view.transactions.ap_invoice.AP_Advance', {
    ...
    initComponent: function(){
        ...
        // Module Data Store
        // *************************************************************************************
        me.store = Ext.create('App.store.transactions.ap_invoice.AP_Advance',{remoteSort: true, pageSize : 20});
        ...
        me.grid = Ext.create('Ext.grid.Panel', {
            ...
            tbar: [
                ...
                },
                {
                    ...
                    width:100,
                    mode:'local',
                    store: [['doc_id',_('document')],['vend_name',_('supplier')],['cash_name',_('cashbank')],['nominal',_('payment_amount')],['reference_id',_('giro_check')],['tax_no','Tax No'],['remarks',_('remarks')],['userinput',_('input_user')]],
                ...
                },
                {
                    ...
                    listeners:{specialkey:function(field, e){if(e.getKey()== e.ENTER){
                        me.store.proxy.extraParams = {doc_type:'U', field_name:me.field_name, field_search:field.value};
                        me.store.loadPage(1);}}
                    }
                },'->',
                {
     ...
     onNewData: function(btn){
         ...
         me.formEditing.context.record.data.doc_type = 'U';
         plugin.editor.form.findField('tax_id').setValue('NT01');
    ...
    onActive: function(callback){
        var me = this;
        me.store.proxy.extraParams = {doc_type: 'U'};
        me.store.load();
        callback(true);
    }
});
