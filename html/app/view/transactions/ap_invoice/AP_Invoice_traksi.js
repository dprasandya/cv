...
Ext.define('App.view.transactions.ap_invoice.AP_Invoice_traksi', {
    extend: 'App.ux.RenderPanel',
    pageTitle: _('invoice')+''+'Traksi',
    initComponent: function(){
        ...
        // Module Data Store
        // *************************************************************************************
        me.store = Ext.create('App.store.transactions.ap_invoice.AP_Invoice',{remoteSort: true, pageSize : 20, autoLoad: false});
        ...
        me.grid = Ext.create('Ext.grid.Panel', {
                                                                            ...
                                                                            listeners:{
                                                                                change:function(field){
                                                                                    ...
                                                                                    var container = field.up('container'), form = container.up('panel'),
                                                                                        ...
                                                                                        ol_id = Ext.ComponentQuery.query('[name=ol_id]', form)[0],
                                                                                        afdeling_id = Ext.ComponentQuery.query('[name=afdeling_id]', form)[0];
                                                                                        
                                                                                    if(me.type=='K'){
                                                                                        for_doc_id.setDisabled(true); afdeling_id.setDisabled(false);ol_id.setDisabled(false); ol_id.setReadOnly(false); warehouse_id.setDisabled(true); vend_id.extraParams =['S']; //project_type.setValue('N');
                                                                                    }else if(me.type=='M'){
                                                                                        for_doc_id.setDisabled(true); afdeling_id.setDisabled(false);ol_id.setDisabled(false); ol_id.setReadOnly(false); warehouse_id.setDisabled(false); vend_id.extraParams =['S']; //project_type.setValue('N');
                                                                                        warehouse_id.extraParams = ['PKS'];
                                                                                    }
                                                                                    else{
                                                                                        for_doc_id.setDisabled(true); vend_id.extraParams =['S'];ol_id.setDisabled(false); ol_id.setReadOnly(false); afdeling_id.setDisabled(true); warehouse_id.setDisabled(true);
            ...
            tbar: [
                ...
                },
                {
                    ...
                    width:100,
                    mode:'local',
                    store: [['doc_id',_('document')],['nopol','Nopol'],['liability',_('liability')],['remarks',_('remarks')],['tax_id',_('tax')],['tax_no',_('tax')+' No'],['for_doc_id','No PO / SO'],['station_name',_('type')],['userinput',_('input_user')]],
