...
Ext.define('App.view.transactions.ap_invoice.AP_Invoice_Retention', {
    extend: 'App.ux.RenderPanel',
    pageTitle: _('invoice_retention'),
    initComponent: function(){
        ...
        // Module Data Store
        // *************************************************************************************
        me.store = Ext.create('App.store.transactions.ap_invoice.AP_Invoice_Retention',{remoteSort: true, pageSize : 20, autoLoad: false});
        ...
        me.grid = Ext.create('Ext.grid.Panel', {
                                                            ...
                                                            items: [
                                                                {
                                                                    ...
                                                                    fieldLabel: _('work_order'),
                                                                    items: [
                                                                        {
                                                                            xtype: 'xtwork_order_progress',
                                                                            width: 180,
                                                                            name: 'for_doc_id',
                                                                            editable: false,
                                                                            emptyText: i18n('document'),
                                                                            extraParams:'outstanding_retention'
                                                                        }
                                                                    ]
                                                                },
                                                                {
            ...
            tbar: [
                ...
                },
                {
                    ...
                    width:100,
                    mode:'local',
                    store: [['project_name',_('project')],['doc_id',_('document')],['vend_name',_('name')],['liability',_('liability')],['remarks',_('remarks')],['tax_id',_('tax')],['tax_no',_('tax')+' No'],['for_doc_id','No PO / SO'],['userinput',_('input_user')]],
    ...
    onNewData: function(btn){
        ...
        plugin.context.record.data.doc_type = 'R';
    ...
    onActive: function(callback){
        var me = this;
        me.store.proxy.extraParams = {doc_type:'R'};
        me.store.load();
        callback(true);
    }
});
