...
Ext.define('App.view.administration.Company', {
    ...
    initComponent: function(){
        ...
        me.grid = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                {text: _('id'),width: 80,sortable: true,dataIndex: 'co_id'},
                {text: _('name'),flex: 1,sortable: true,dataIndex: 'co_name'},
            ...
            tbar: [
                ...
                },
                {
                    ...
                    width:100,
                    mode:'local',
                    store: [['co_id',_('id')],['co_name',_('name')],['address',_('address')],['city',_('city')],['remarks',_('remarks')]],
