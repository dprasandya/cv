            ...
            items: [
                ...
                */
                ...
                },
                {
                    ...
                    queryMode: 'local',
                    fieldLabel: 'Site',
                    store:[['LSU','CV Lestari sejahtera utama'],['AJB','CV Armada jaya bersama'],['TJA','CV Tawar Jaya'],['DTR','CV Dian Timur'],['MLB','CV Maju Lestari bersama'],['DSU','CV Dewi Sri utama'],['HGA','CV. Hapakat Gemilang Abadi'],['RRB','CV. Rukun Raharja Bersama'],['BBU','CV. Budi Bakti Utama'],['ARG','CV. Adipati Raya Gemilang'],['PMS','CV. Persada Mojokerto Sejahtera'],['TJS','CV. Toba Jaya Sentosa'],['DAU','CV. Duta Andalan Utama'],['BSS','CV. Bumi Sumatera Sejahtera'],['KPS','CV. Karunia Persada Sumatera'],['BPB','CV. Berkah Putra Borneo'],['DCB','CV. Dua Cahaya Borneo']]
//                    store:[['LSU','CV Lestari sejahtera utama'],['DTR','CV Dian Timur']]
},
            ],
            buttons: [
                /*
        ...
        if(me.showSite){
            Ext.Array.insert(me.formLogin.items, 3, [{
                ...
                //mode:'local',
                //store:[['LSU','CV Lestari sejahtera utama'],['AJB','CV Armada jaya bersama'],['TJA','CV Tawar Jaya'],['DTR','CV Dian Timur'],['MLB','CV Maju Lestari bersama'],['DSU','CV Dewi Sri utama']],
                allowBlank: false,
                editable: false,
                msgTarget: 'side',
                labelWidth: 100,
        ...
        var windowItems = [
            {
                ...
                width: 383,
                height: 135,
                html: '<img src="resources/images/blank.png" width="100%" height="100%" />'
            }
        ];
        ...
        me.winLogon = Ext.create('widget.window', {
            title: 'Accounting Software Logon',
            closeAction: 'hide',
            plain: true,
            modal: false,
            resizable: false,
