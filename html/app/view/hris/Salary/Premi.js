...
Ext.define('App.view.hris.Salary.Premi', {
    ...
    initComponent: function(){
        ...
        me.grid = Ext.create('Ext.grid.Panel', {
            ...
            viewConfig :
            {
                stripeRows: false,
                getRowClass: function(record, index) {
                    return record.get('attendance_status') == 'H' ? 'child-row' : (record.get('status') == '2' ? 'adult-row':'');
                }
            },
            listeners:{
                    ...
                    listeners: {
                        ...
                        beforeedit: function(editor,e,opt){
                            if(e.record.data.attendance_status!='H'){
                                ...
                                var afdeling_id  = form.findField('afdeling_id');
                                if(e.record.data.pks_afdeling=='PKS'){
                                    afdeling_id.setDisabled(true);
                                }else{
