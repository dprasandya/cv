...
Ext.define('App.view.hris.employee.Employee_no_edit', {
    ...
    initComponent: function(){
        ...
        me.grid = Ext.create('Ext.grid.Panel', {
                ...
                me.formEditing = Ext.create('App.ux.grid.RowFormEditing', {
                    ...
                    items: [
                        me.employee_tab = Ext.create('Ext.tab.Panel', {
                            ...
                            }, me.grid_emp_education, me.grid_emp_dependents, me.grid_emp_emergency_contact, me.grid_emp_work_experience, me.grid_emp_training, me.grid_emp_report_spv,me.grid_emp_position,  me.grid_emp_salary ],
                            listeners: {
                                render: function() {
                                    this.items.each(function(i, index, items){
                                        i.tab.on('click', function(){
            ...
            listeners: {
                itemclick: function(dv, record, item, index, e) {
                    var useredit = me.grid.down('toolbar'), plugin = me.grid.editingPlugin,  view_data_gaji=null;  me.employee_tab.setActiveTab(0); me.emp_id = record.data.emp_id;
                    ...
                    plugin.editor.form.findField('emp_id').setDisabled(true);
                    plugin.editor.form.findField('emp_first_name').setDisabled(true);
                    plugin.editor.form.findField('emp_midle_name').setDisabled(true);
                    plugin.editor.form.findField('emp_last_name').setDisabled(true);
                    plugin.editor.form.findField('emp_ktp').setDisabled(true);
                    plugin.editor.form.findField('emp_bank_01').setDisabled(true);
                    plugin.editor.form.findField('emp_bank_02').setDisabled(true);
                }
            },
            columns: [
    ...
    onNewUser: function(btn){
        ...
        if(model.modelName=='App.model.hris.employee.Employee'){
            plugin.editor.form.findField('emp_id').setDisabled(false);
            plugin.editor.form.findField('emp_first_name').setDisabled(false);
            plugin.editor.form.findField('emp_midle_name').setDisabled(false);
            plugin.editor.form.findField('emp_last_name').setDisabled(false);
            plugin.editor.form.findField('emp_ktp').setDisabled(false);
            plugin.editor.form.findField('emp_bank_01').setDisabled(false);
            plugin.editor.form.findField('emp_bank_02').setDisabled(false);
