...
Ext.define('App.view.hris.employee.Position', {
    extend: 'App.ux.RenderPanel',
    id: 'panelPosition',
    pageTitle: _('position'),
    initComponent: function(){
        ...
        // Module Data Store
        // *************************************************************************************
        me.store = Ext.create('App.store.hris.employee.Position',{remoteSort: true, pageSize : 20, autoLoad: false});
        me.grid = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                {text: _('id'),width: 80,sortable: true,dataIndex: 'pos_id'},
                {text: _('name'),flex: 1,sortable: true,dataIndex: 'pos_name'},
            ...
            tbar: [
                ...
                },
                {
                    ...
                    width:100,
                    mode:'local',
                    store: [['pos_id',_('id')],['pos_name',_('name')],['dept_name',_('department')],['remarks',_('remarks')]],
