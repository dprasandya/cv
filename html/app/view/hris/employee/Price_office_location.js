...
Ext.define('App.view.hris.employee.Price_office_location', {
    extend: 'App.ux.RenderPanel',
    pageTitle: _('price_list'),
    initComponent: function(){
        ...
        // Module Data Store
        // *************************************************************************************
        me.store = Ext.create('App.store.hris.employee.Price_office_location',{remoteSort: true, pageSize : 20, autoLoad: false});
        me.grid = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                {text: _('location'),width: 150,sortable: true,dataIndex: 'ol_name'},
            ...
            tbar: [
                ...
                },
                {
                    ...
                    width:100,
                    mode:'local',
                    store: [['js_name',_('job_status')],['ol_name',_('office_location')],['remarks',_('remarks')]],
