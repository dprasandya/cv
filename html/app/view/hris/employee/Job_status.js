...
Ext.define('App.view.hris.employee.Job_status', {
    extend: 'App.ux.RenderPanel',
    id: 'panelJob_status',
    pageTitle: _('job_status'),
    initComponent: function(){
        ...
        // Module Data Store
        // *************************************************************************************
        me.store = Ext.create('App.store.hris.employee.Job_status',{remoteSort: true, pageSize : 20, autoLoad: false});
        me.grid = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                {text: _('id'),width: 80,sortable: true,dataIndex: 'js_id'},
                {text: _('name'),flex: 1,sortable: true,dataIndex: 'js_name'},
                {text: _('inc_premi'),width: 80,sortable: true,renderer: me.boolRenderer,dataIndex: 'inc_premi'},
            ...
            tbar: [
                ...
                },
                {
                    ...
                    width:100,
                    mode:'local',
                    store: [['js_id',_('id')],['js_name',_('name')],['remarks',_('remarks')]],
