Ext.define('App.view.hris.popup.Overtime_request',
    {
        extend : 'Ext.form.field.Trigger',
        alias : 'widget.xtovertime_request',
        ...
        initComponent : function()
        {
            ...
            me.model =Ext.define('model',{
                ...
                proxy:{
                    type:'direct',
                    api:{
                        read: HRIS_Overtime_request.popup
                    },
                    reader :{
                        root: 'rows',
            ...
            me.grid = Ext.create('Ext.grid.Panel', {
                ...
                columns: [
                    {text: _('no'),width: 80,sortable: true,dataIndex: 'seq_id'},
                    ...
                    {text: _('remarks'),width: 100,sortable: true,dataIndex: 'remarks'}
                ],
                tbar: [
                    {
                        xtype:'combo',
