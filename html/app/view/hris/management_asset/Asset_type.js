...
Ext.define('App.view.hris.management_asset.Asset_type', {
    extend: 'App.ux.RenderPanel',
    pageTitle: _('asset_type'),
    initComponent: function(){
        ...
        // Module Data Store
        // *************************************************************************************
        me.store = Ext.create('App.store.hris.management_asset.Asset_type',{remoteSort: true, pageSize : 20, autoLoad: false});
        me.grid = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                {text: _('type'),width: 150,sortable: true,dataIndex: 'asset_type'},
            ...
            tbar: [
                ...
                },
                {
                    ...
                    width:100,
                    mode:'local',
                    store: [['asset_type',_('type')],['remarks',_('remarks')]],
