...
Ext.define('App.view.master.Rounding', {
    extend: 'App.ux.RenderPanel',
    id: 'panelRounding',
    pageTitle: _('rounding'),
    initComponent: function(){
        ...
        me.model =Ext.define('model',{
            ...
            fields :[
                ...
                {name:'coa_ap_name', type:'string'},
                {name:'nominal_ap', type:'float'},
                {name:'coa_ar', type:'string'},
                {name:'coa_ar_name', type:'string'},
                {name:'nominal_ar', type:'float'},
            ...
            proxy:{
                type:'direct',
                api:{
                    read: Rounding.select,
                    create: Rounding.add,
                    update: Rounding.update,
                    destroy: Rounding.delete
                },
                reader :{
                    root: 'rows',
        ...
        me.grid = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                {text: _('ap'),width: 80,sortable: true,dataIndex: 'coa_ap'},
                {text: _('name'),flex: 1,sortable: true,dataIndex: 'coa_ap_name'},
                {text: _('ar'),width: 80,sortable: true,dataIndex: 'coa_ar'},
                {text: _('name'),flex: 1,sortable: true,dataIndex: 'coa_ar_name'},
            ...
            tbar: [
                ...
                },
                {
                    ...
                    width:100,
                    mode:'local',
                    store: [['coa_ap',_('ap')],['coa_ar',_('ar')],['remarks',_('remarks')]],
