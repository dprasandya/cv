...
Ext.define('App.view.master.CashBank', {
    extend: 'App.ux.RenderPanel',
    id: 'panelCashBank',
    pageTitle: _('cashbank'),
    initComponent: function(){
        ...
        me.model =Ext.define('model',{
            ...
            proxy:{
                type:'direct',
                api:{
                    read: CashBank.select,
                    create: CashBank.add,
                    update: CashBank.update,
                    destroy: CashBank.delete
                },
                reader :{
                    root: 'rows',
        ...
        me.grid = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                ...
                {text: _('type'),width: 100,sortable: true, align:'center',
                    renderer: function (value, metaData, record, rowIndex, colIndex, store) {
                        var returnString = record.data.cash_type=='C'? _('cash'): 'Bank' ;
                        return returnString;
                    }},
                {text: _('account'),width: 80,sortable: true,dataIndex: 'coa_id'},
                {text: _('account')+' '+_('name'),width: 100,sortable: true,dataIndex: 'coa_name'},
            ...
            tbar: [
                ...
                },
                {
                    ...
                    width:100,
                    mode:'local',
                    store: [['cash_id',_('id')],['cash_name',_('name')],['remarks',_('remarks')],['coa_id',_('account')],['cash_type',_('type')]],
