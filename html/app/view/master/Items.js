...
Ext.define('App.view.master.Items', {
        ...
        me.grid = Ext.create('Ext.grid.Panel', {
            ...
            tbar: [
                ...
                },
                {
                    ...
                    width:100,
                    mode:'local',
                    store: [['item_id',_('id')],['item_name',_('name')],['remarks',_('remarks')],['unit_id',_('unit')],['item_type',_('type')]],
                ...
                },
                {
                    ...
                    listeners:{specialkey:function(field, e){if(e.getKey()== e.ENTER){
                        me.store.proxy.extraParams = {item_type:['RM'], field_name:me.field_name, field_search:field.value};
                        me.store.loadPage(1);}}
                    }
                },'->',
                {
    ...
    onNewUser: function(){
        ...
        me.formEditing.context.record.data.item_type = 'RM';
    },
    /**
    ...
    onActive: function(callback){
        this.store.proxy.extraParams={item_type:['RM']};
        this.store.load();
        callback(true);
    }
});
