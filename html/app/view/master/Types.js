...
Ext.define('App.view.master.Types', {
    ...
    initComponent: function(){
        ...
        me.grid = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                {text: _('id'),width: 80,sortable: true,dataIndex: 'type_id'},
                {text: _('name'),flex: 1,sortable: true,dataIndex: 'type_name'},
            ...
            tbar: [
                ...
                },
                {
                    ...
                    width:100,
                    mode:'local',
                    store: [['type_id',_('id')],['type_name',_('name')],['remarks',_('remarks')]],
