...
Ext.define('App.view.master.RoomStatus', {
    ...
    initComponent: function(){
        ...
        me.model =Ext.define('model',{
            ...
            proxy:{
                type:'direct',
                api:{
                    read: RoomStatus.select,
                    create: RoomStatus.add,
                    update: RoomStatus.update,
                    destroy: RoomStatus.delete
                },
                reader :{
                    root: 'rows',
        ...
        me.grid = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                {text: _('id'),width: 80,sortable: true,dataIndex: 'rs_id'},
                {text: _('name'),flex: 1,sortable: true,dataIndex: 'rs_name'},
            ...
            tbar: [
                ...
                },
                {
                    ...
                    width:100,
                    mode:'local',
                    store: [['rs_id',_('id')],['rs_name',_('name')],['remarks',_('remarks')]],
