...
Ext.define('App.view.master.Station', {
    ...
    initComponent: function(){
        ...
        me.grid = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                {text: _('id'),width: 80,sortable: true,dataIndex: 'station_id'},
                {text: _('name'),flex: 1,sortable: true,dataIndex: 'station_name'},
            ...
            tbar: [
                ...
                },
                {
                    ...
                    width:100,
                    mode:'local',
                    store: [['station_id',_('id')],['station_name',_('name')],['remarks',_('remarks')]],
