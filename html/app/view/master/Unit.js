...
Ext.define('App.view.master.Unit', {
    ...
    initComponent: function(){
        ...
        me.grid = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                {text: _('id'),width: 80,sortable: true,dataIndex: 'unit_id'},
                {text: _('name'),flex: 1,sortable: true,dataIndex: 'unit_name'},
            ...
            tbar: [
                ...
                },
                {
                    ...
                    width:100,
                    mode:'local',
                    store: [['unit_id',_('id')],['unit_name',_('name')],['remarks',_('remarks')]],
