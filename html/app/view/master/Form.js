...
Ext.define('App.view.master.Form', {
    ...
    initComponent: function(){
        ...
        me.grid = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                {text: _('id'),width: 80,sortable: true,dataIndex: 'form_id'},
                {text: _('name'),flex: 1,sortable: true,dataIndex: 'form_name'},
            ...
            tbar: [
                ...
                },
                {
                    ...
                    width:100,
                    mode:'local',
                    store: [['form_id',_('id')],['form_name',_('name')],['remarks',_('remarks')]],
