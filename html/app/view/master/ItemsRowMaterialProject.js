...
Ext.define('App.view.master.ItemsRowMaterialProject', {
    extend: 'App.ux.RenderPanel',
    pageTitle: _('row_material_project'),
    initComponent: function(){
        ...
        me.model =Ext.define('model',{
            ...
            fields :[
                ...
                {name:'coa_intransit', type:'string'},
                {name:'coa_intransit_name', type:'string'},
        ...
        me.grid = Ext.create('Ext.grid.Panel', {
                                                    ...
                                                    items: [
                                                        {
                                                            ...
                                                            //allowBlank: false,
                                                            emptyText: i18n('id'),
                                                            extraParams:{project_id:'',doc_type:''}
                                                        },
                                                        {
                                                            width: 280,
                                                            xtype: 'textfield',
            ...
            tbar: [
                ...
                },
                {
                    ...
                    width:100,
                    mode:'local',
                    store: [['item_id',_('id')],['item_name',_('name')],['unit_id',_('unit')],['costcode_id',_('costcode')+' Id'],['costcode_name',_('costcode')+' '+_('name')],['remarks',_('remarks')]],
                ...
                },
                {
                    ...
                    listeners:{specialkey:function(field, e){if(e.getKey()== e.ENTER){
                        me.store.proxy.extraParams = {item_type:'RP', field_name:me.field_name, field_search:field.value};
                        me.store.loadPage(1);}}
                    }
                },'->',
                {
    ...
    onNewUser: function(){
        ...
        me.formEditing.context.record.data.item_type = 'RP';
    },
    /**
    ...
    onActive: function(callback){
        this.store.proxy.extraParams={item_type:'RP'};
        this.store.load();
        callback(true);
    }
});
