    ...
    initComponent: function(){
        ...
        me.model =Ext.define('model',{
                ...
                fields :[
                    ...
                    {name:'cflow_type', type:'string'},
                    {name:'cflow_group', type:'string'},
                ...
                proxy:{
                    type:'direct',
                    api:{
                        read: Cashflow.select,
                        create: Cashflow.add,
                        update: Cashflow.update,
                        destroy: Cashflow.delete
                    },
                    reader :{
                        root: 'rows',
        ...
        me.grid = Ext.create('Ext.grid.Panel', {
                                                ...
                                                },
                                                {
                                                    ...
                                                    items: [
                                                        ...
                                                        },
                                                        {
                                                            ...
                                                            width:150,
                                                            mode:'local',
                                                            store: ['Operasional','Investasi','Pendanaan'],
            ...
            columns: [
                {text: _('id'),width: 80,sortable: true,dataIndex: 'cflow_id'},
                {text: _('name'),flex: 1,sortable: true,dataIndex: 'cflow_name'},
                {text: _('remarks'),flex: 1,sortable: true,dataIndex: 'remarks'},
                {text: _('type'),width: 100,sortable: true, align:'center',
                    renderer: function (value, metaData, record, rowIndex, colIndex, store) {
                        var returnString = record.data.cflow_type=='I'? _('in'): _('out') ;
                        return returnString;
                    }},
                {text: _('group_name'),width: 100,sortable: true,dataIndex: 'cflow_group'},
            ...
            tbar: [
                ...
                },
                {
                    ...
                    width:100,
                    mode:'local',
                    store: [['cflow_id',_('id')],['cflow_name',_('name')],['cflow_type',_('type')],['cflow_group',_('group_name')],['remarks',_('remarks')]],
