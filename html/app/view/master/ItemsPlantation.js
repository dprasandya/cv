...
Ext.define('App.view.master.ItemsPlantation', {
    extend: 'App.ux.RenderPanel',
    pageTitle: _('items_plantation'),
    initComponent: function(){
        ...
        me.model =Ext.define('model',{
            ...
            proxy:{
                type:'direct',
                api:{
                    read: ItemsPlantation.select,
                    create: ItemsPlantation.add,
                    update: ItemsPlantation.update,
                    destroy: ItemsPlantation.delete
                },
                reader :{
                    root: 'rows',
        ...
        me.grid = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                ...
                {text: _('account')+' '+_('name'),flex: 1,sortable: true,dataIndex: 'coa_name'},
            ...
            tbar: [
                ...
                },
                {
                    ...
                    width:100,
                    mode:'local',
                    store: [['item_id',_('id')],['item_name',_('name')],['item_type',_('type')],['unit_id',_('unit')],['coa_id',_('account')],['remarks',_('remarks')]],
                ...
                },
                {
                    ...
                    listeners:{specialkey:function(field, e){if(e.getKey()== e.ENTER){
                        me.store.proxy.extraParams = {item_type:['HK'], field_name:me.field_name, field_search:field.value};
                        me.store.loadPage(1);}}
                    }
                },'->',
                {
    ...
    onNewUser: function(){
        ...
        me.formEditing.context.record.data.item_type = 'HK';
    },
    /**
    ...
    onActive: function(callback){
        this.store.proxy.extraParams={item_type:['HK']};
        this.store.load();
        callback(true);
    }
});
