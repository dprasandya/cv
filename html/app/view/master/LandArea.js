...
Ext.define('App.view.master.LandArea', {
    extend: 'App.ux.RenderPanel',
    pageTitle: _('land_area'),
    initComponent: function(){
        ...
        me.model =Ext.define('model',{
            ...
            proxy:{
                type:'direct',
                api:{
                    read: LandArea.select,
                    create: LandArea.add,
                    update: LandArea.update,
                    destroy: LandArea.delete
                },
                reader :{
                    root: 'rows',
        ...
        me.grid = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                ...
                {text: _('land_dedicated'),width: 100,sortable: true,dataIndex: 'land_dedicated', align:'right', renderer: Ext.util.Format.numberRenderer('0,000.00')},
                {text: _('public_facilities'),width: 100,sortable: true,dataIndex: 'public_facilities', align:'right', renderer: Ext.util.Format.numberRenderer('0,000.00')},
                {text: _('net_effective'),width: 100,sortable: true,dataIndex: 'net_effective', align:'right', renderer: Ext.util.Format.numberRenderer('0,000.00')},
            ...
            tbar: [
                ...
                },
                {
                    ...
                    width:100,
                    mode:'local',
                    store: [['project_name',_('project')],['land_dedicated',_('land_dedicated')],['public_facilities',_('public_facilities')],['net_effective',_('net_effective')],['remarks',_('remarks')]],
