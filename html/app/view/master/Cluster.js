...
Ext.define('App.view.master.Cluster', {
    ...
    initComponent: function(){
        ...
        me.grid = Ext.create('Ext.grid.Panel', {
                                            ...
                                            items: [
                                                {
                                                    ...
                                                    items: [
                                                        ...
                                                        },
                                                        {
                                                            ...
                                                            width:200,
                                                            mode:'local',
                                                            store: [['LH',_('landed_house')],['HB',_('highrise_building')]]
                                                        }
                                                    ]
                                                },
                                                {
            ...
            columns: [
                ...
                {text: _('type'),width: 100,sortable: true, align:'center',
                    renderer: function (value, metaData, record, rowIndex, colIndex, store) {
                        var returnString = record.data.property_type=='LH'? _('landed_house'): _('highrise_building') ;
                        return returnString;
                    }},
            ...
            features: [{
                groupHeaderTpl: _('project')+' : {[values.rows[0].data.project_name]} ',
            ...
            tbar: [
                ...
                },
                {
                    ...
                    width:100,
                    mode:'local',
                    store: [['project_name',_('project')],['cluster_id',_('id')],['cluster_name',_('name')],['remarks',_('remarks')]],
