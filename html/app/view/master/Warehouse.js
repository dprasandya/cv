...
Ext.define('App.view.master.Warehouse', {
    extend: 'App.ux.RenderPanel',
    id: 'panelWarehouse',
    pageTitle: _('warehouse'),
    initComponent: function(){
        ...
        me.model =Ext.define('model',{
            ...
            proxy:{
                type:'direct',
                api:{
                    read: Warehouse.select,
                    create: Warehouse.add,
        ...
        me.grid = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                {text: _('id'),width: 80,sortable: true,dataIndex: 'warehouse_id'},
                {text: _('name'),flex: 1,sortable: true,dataIndex: 'warehouse_name'},
            ...
            tbar: [
                ...
                },
                {
                    ...
                    width:100,
                    mode:'local',
                    store: [['warehouse_id',_('id')],['warehouse_name',_('name')],['remarks',_('remarks')],['city',_('city')],['address',_('address')]],
