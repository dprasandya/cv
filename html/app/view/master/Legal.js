...
Ext.define('App.view.master.Legal', {
    ...
    initComponent: function(){
        ...
        me.grid = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                {text: _('id'),width: 80,sortable: true,dataIndex: 'legal_id'},
                {text: _('name'),flex: 1,sortable: true,dataIndex: 'legal_name'},
            ...
            tbar: [
                ...
                },
                {
                    ...
                    width:100,
                    mode:'local',
                    store: [['legal_id',_('id')],['legal_name',_('name')],['remarks',_('remarks')]],
