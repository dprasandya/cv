...
Ext.define('App.view.master.Department', {
    ...
    initComponent: function(){
        ...
        me.grid = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                {text: _('id'),width: 80,sortable: true,dataIndex: 'department_id'},
                {text: _('name'),flex: 1,sortable: true,dataIndex: 'department_name'},
            ...
            tbar: [
                ...
                },
                {
                    ...
                    width:100,
                    mode:'local',
                    store: [['department_id',_('id')],['department_name',_('name')],['remarks',_('remarks')]],
