...
Ext.define('App.view.master.ItemsFormerBag', {
    extend: 'App.ux.RenderPanel',
    pageTitle: _('former_bag'),
    initComponent: function(){
        ...
        me.model =Ext.define('model',{
            ...
            proxy:{
                type:'direct',
                api:{
                    read: ItemsFormerBag.select,
                    create: ItemsFormerBag.add,
                    update: ItemsFormerBag.update,
                    destroy: ItemsFormerBag.delete
                },
                reader :{
                    root: 'rows',
