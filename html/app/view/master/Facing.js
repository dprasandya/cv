...
Ext.define('App.view.master.Facing', {
    ...
    initComponent: function(){
        ...
        me.model =Ext.define('model',{
            ...
            proxy:{
                ...
                api:{
                    read: Facing.select,
                    create: Facing.add,
                    update: Facing.update,
                    destroy: Facing.delete
                },
                reader :{
                    root: 'rows',
        ...
        me.grid = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                ...
                {text: _('id'),width: 80,sortable: true,dataIndex: 'facing_id'},
                {text: _('name'),flex: 1,sortable: true,dataIndex: 'facing_name'},
            ...
            tbar: [
                ...
                },
                {
                    ...
                    width:100,
                    mode:'local',
                    store: [['project_name',_('project')],['cluster_name',_('name')],['facing_id',_('id')],['facing_name',_('name')],['remarks',_('remarks')]],
