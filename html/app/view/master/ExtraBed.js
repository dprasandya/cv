...
Ext.define('App.view.master.ExtraBed', {
    extend: 'App.ux.RenderPanel',
    pageTitle: _('extra_bed'),
    initComponent: function(){
        ...
        me.model =Ext.define('model',{
            ...
            proxy:{
                type:'direct',
                api:{
                    read: ExtraBed.select,
                    create: ExtraBed.add,
                    update: ExtraBed.update,
                    destroy: ExtraBed.delete
                },
                reader :{
                    root: 'rows',
        ...
        me.grid = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                {text: _('id'),width: 80,sortable: true,dataIndex: 'bed_id'},
                {text: _('name'),flex: 1,sortable: true,dataIndex: 'bed_name'},
            ...
            tbar: [
                ...
                },
                {
                    ...
                    width:100,
                    mode:'local',
                    store: [['rt_id',_('id')],['rt_name',_('name')],['remarks',_('remarks')]],
