...
Ext.define('App.view.master.Kpa', {
        ...
        me.grid = Ext.create('Ext.grid.Panel', {
            ...
            listeners: {
                itemclick: function(dv, record, item, index, e) {
                    var cash_id_old = me.grid.editingPlugin.editor.form.findField('cash_id_old');
                    cash_id_old.setValue(record.data.cash_id);
            ...
            columns: [
                ...
                {text: 'AJB (%)',width: 80,sortable: true,dataIndex: 'ajb', align:'right', renderer: Ext.util.Format.numberRenderer('0,000.00%')},
                {text: 'BAST (%)',width: 80,sortable: true,dataIndex: 'bast', align:'right', renderer: Ext.util.Format.numberRenderer('0,000.00%')},
                {text: 'Topping Off (%)',width: 80,sortable: true, dataIndex: 'topping_off', align:'right', renderer: Ext.util.Format.numberRenderer('0,000.00%')},
