...
Ext.define('App.model.transactions.stock.Stock_out_traksi', {
    ...
    proxy:{
        type:'direct',
        api:{
            read: Stock_out_traksi.select,
            create: Stock_out_traksi.add,
            update: Stock_out_traksi.update,
            destroy: Stock_out_traksi.delete
        },
        reader :{
            root: 'rows',
