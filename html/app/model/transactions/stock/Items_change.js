...
Ext.define('App.model.transactions.stock.Items_change', {
    ...
    proxy:{
        type:'direct',
        api:{
            read: Items_change.select,
            create: Items_change.add,
            update: Items_change.update,
            destroy: Items_change.delete
        },
        reader :{
            root: 'rows',
