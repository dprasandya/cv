...
Ext.define('App.model.transactions.marketing.Registration_unit_co', {
    ...
    fields :[
        ...
        {name:'refund_cflow_id', type:'string'},
    ...
    proxy:{
        type:'direct',
        api:{
            read: Registration_unit_co.select,
            create: Registration_unit_co.add,
            update: Registration_unit_co.update,
            destroy: Registration_unit_co.delete
        },
        reader :{
            root: 'rows',
