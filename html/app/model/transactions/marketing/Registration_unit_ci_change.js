...
Ext.define('App.model.transactions.marketing.Registration_unit_ci_change', {
    ...
    proxy:{
        type:'direct',
        api:{
            read: Registration_unit_ci_change.select,
            update: Registration_unit_ci_change.update
        },
        reader :{
            root: 'rows',
