...
Ext.define('App.model.transactions.marketing.Registration_change', {
    ...
    proxy:{
        type:'direct',
        api:{
            read: Registration_change.select,
            create: Registration_change.add,
            update: Registration_change.update,
            destroy: Registration_change.delete
        },
        reader :{
            root: 'rows',
