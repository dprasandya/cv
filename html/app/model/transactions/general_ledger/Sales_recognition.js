...
Ext.define('App.model.transactions.general_ledger.Sales_recognition', {
    ...
    fields :[
        ...
        {name:'acc_depreciation_value', type:'float'},
    ...
    proxy:{
        type:'direct',
        api:{
            read: Sales_recognition.select,
            create: Sales_recognition.add,
            update: Sales_recognition.update
        },
        reader :{
            root: 'rows',
