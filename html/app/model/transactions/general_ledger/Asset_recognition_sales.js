...
Ext.define('App.model.transactions.general_ledger.Asset_recognition_sales', {
    ...
    proxy:{
        type:'direct',
        api:{
            read: Asset_recognition_sales.select,
            create: Asset_recognition_sales.add,
            update: Asset_recognition_sales.update
        },
        reader :{
            root: 'rows',
