...
class HRIS_Emp_Emergency_Contact
{
    /**
     * @var dbHelper
     */
    ...
    public function select(stdClass $params)
    {
        ...
        $sql = "SELECT * FROM hris_emp_emergency_contact where co_id='$co_id' and emp_id='$params->emp_id' $par_search order by timeedit asc";
        $this->db->setSQL($sql);
        $rows = array();
    ...
    public function add(stdClass $params)
    {
        ...
        $sql = $this->db->sqlBind($data, 'hris_emp_emergency_contact', 'I');
        $this->db->setSQL($sql);
        $this->db->execLog();
        return $params;
    }
    public function update(stdClass $params)
    {
        ...
        $sql = $this->db->sqlBind($data, 'hris_emp_emergency_contact', 'U', array('co_id'=>$params->co_id,'emp_id' => $params->emp_id, 'seq_id' => $params->seq_id));
        $this->db->setSQL($sql);
        $this->db->execLog();
        return $params;
    }
    public function delete(stdClass $params){
        $this->db->setSQL("delete from hris_emp_emergency_contact where co_id='$params->co_id' and emp_id = '$params->emp_id' and seq_id = '$params->seq_id'");
        $this->db->execLog();
        return $params;
    }
