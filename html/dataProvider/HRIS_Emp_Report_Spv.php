...
class HRIS_Emp_Report_Spv
{
    ...
    public function select(stdClass $params)
    {
        ...
        $sql = "SELECT * FROM hris_emp_report_spv where co_id='$co_id' and emp_id='$params->emp_id' $par_search order by timeedit asc";
        $this->db->setSQL($sql);
        $rows = array();
    ...
    public function add(stdClass $params)
    {
        ...
        $sql = $this->db->sqlBind($data, 'hris_emp_report_spv', 'I');
        $this->db->setSQL($sql);
        $this->db->execLog();
        return $params;
    }
    public function update(stdClass $params)
    {
        ...
        $sql = $this->db->sqlBind($data, 'hris_emp_report_spv', 'U', array('co_id'=>$params->co_id,'emp_id' => $params->emp_id, 'emp_spv_id' => $params->emp_spv_id));
        $this->db->setSQL($sql);
        $this->db->execLog();
        return $params;
    }
    public function delete(stdClass $params){
        ...
        $co_id = $_SESSION['user']['site'];
        $sql = "delete from hris_emp_report_spv where co_id='$co_id' and emp_id = '$params->emp_id' and emp_spv_id ='$params->emp_spv_id'";
        $this->db->setSQL($sql);
        $this->db->execLog();
        return $params;
    }
