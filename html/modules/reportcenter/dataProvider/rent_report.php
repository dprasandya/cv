...
class rent_report extends Reports
{
    /*
    ...
    public function unit_building_rent_report(\stdClass $params)
    {
        $params->params->report_co_id = $_SESSION['user']['site'];
        $this->reportfile = ROOT . '/modules/reportcenter/report/rent_report/unit_building_rent_report.jasper';
